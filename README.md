...
highlighting/underline/strike/multi-line notes (with color swatches and a search field in
the Annotations dialog) with export to Markdown, bookmarks, in-document search, continuous
